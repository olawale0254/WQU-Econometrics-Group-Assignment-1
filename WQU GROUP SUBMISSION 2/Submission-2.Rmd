...
#### 2.1 Describe the economic theories and models used to calculate equilibrium FX.
#### 2.2 Indicate macroeconomic variables used to determine the equilibrium FX.

#### 2.3 Explain the connection between linear regression and Vector Error Correction (VEC).

#### 2.4 Calculate the equilibrium FX using VEC and comment all your results. You may use the Behavioral Equilibrium Exchange Rate (BEER) approach
